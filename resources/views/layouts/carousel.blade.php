            ...
            <div class="relative w-1/4 bg-gray-200">
                <div class="static mt-20 mx-10 ">
                    ...
                    <div class="flex justify-center space-x-2 mx-4 my-4">
                        <button class="bg-white hover:bg-blue-700 text-white px-2 py-1 border border-slate-200 rounded">1</button>
                        <button class="bg-gray-400 hover:bg-green-700 text-white px-2 py-1 border border-slate-200 rounded">2</button>
                        <button class="bg-gray-700 hover:bg-yellow-700 text-white px-2 py-1 border border-slate-200 rounded">3</button>
                        <button class="bg-blue-600 hover:bg-yellow-700 text-white px-2 py-1 border border-slate-200 rounded">4</button>
                        <button class="bg-yellow-600 hover:bg-yellow-700 text-white px-2 py-1 border border-slate-200 rounded">5</button>
                        <button class="bg-red-600 hover:bg-yellow-700 text-white px-2 py-1 border border-slate-200 rounded">6</button>
                    </div>
